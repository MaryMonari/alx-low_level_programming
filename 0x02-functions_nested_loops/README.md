...
9 -times-table -  a function that prints the 9 times table, starting with 0
10- a + b- a function that adds two integers and returns the result
11- print to 98.c - a function that prints all natural numbers from n to 98, followed by a new line
